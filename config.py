...
pretrained_sovits_name = {
    "v1": "GPT_SoVITS/pretrained_models/SoVITS_G.pth",
...
pretrained_gpt_name = {
    "v1": "GPT_SoVITS/pretrained_models/GPT.ckpt",
...
# 推理用的指定模型
sovits_path = "model/SoVITS_G.pth"
gpt_path = "model/GPT.ckpt"
is_half_str = os.environ.get("is_half", "True")
is_half = True if is_half_str.lower() == "true" else False
is_share_str = os.environ.get("is_share", "False")
is_share = True if is_share_str.lower() == "true" else False

cnhubert_path = "model/chinese-hubert-base"
bert_path = "model/chinese-roberta-wwm-ext-large"
pretrained_sovits_path = "model/SoVITS_G.pth"
pretrained_gpt_path = "model/GPT.ckpt"
...
class Config:
    def __init__(self):
        self.sovits_path = "model/SoVITS_G.pth"
        self.gpt_path = "model/GPT.ckpt"
        self.is_half = is_half

        self.cnhubert_path = "model/chinese-hubert-base"
        self.bert_path = "model/chinese-roberta-wwm-ext-large"
